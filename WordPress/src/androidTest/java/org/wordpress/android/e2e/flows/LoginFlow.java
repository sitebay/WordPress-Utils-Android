...
import static org.sitebay.android.BuildConfig.E2E_WP_COM_USER_USERNAME;
import static org.sitebay.android.support.WPSupportUtils.atLeastOneElementWithIdIsDisplayed;
...
public class LoginFlow {
    ...
    public LoginFlow openMagicLink(ActivityTestRule<LoginMagicLinkInterceptActivity> magicLinkActivityTestRule) {
        ...
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("sitebay://magic-login?token=valid_token"))
