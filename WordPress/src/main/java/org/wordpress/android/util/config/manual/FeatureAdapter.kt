...
import org.sitebay.android.util.config.manual.FeatureItemViewHolder.ButtonViewHolder
import org.sitebay.android.util.config.manual.FeatureItemViewHolder.FeatureViewHolder
import org.sitebay.android.util.config.manual.FeatureItemViewHolder.HeaderViewHolder
...
import org.sitebay.android.util.config.manual.ManualFeatureConfigViewModel.FeatureUiItem.Type
import org.sitebay.android.util.config.manual.ManualFeatureConfigViewModel.FeatureUiItem.Type.BUTTON
import org.sitebay.android.util.config.manual.ManualFeatureConfigViewModel.FeatureUiItem.Type.FEATURE
import org.sitebay.android.util.config.manual.ManualFeatureConfigViewModel.FeatureUiItem.Type.HEADER
