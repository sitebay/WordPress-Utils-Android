...
private val PASSWORD_SELF_HOSTED_PATTERN = Pattern.compile("^(.)+$")
...
fun validatePasswordSelfHosted(text: CharSequence): Boolean = validate(PASSWORD_SELF_HOSTED_PATTERN, text)
