...
import org.sitebay.android.databinding.ReaderFragmentPostDetailBinding
...
import org.sitebay.android.ui.reader.ReaderActivityLauncher.OpenUrlType
...
import org.sitebay.android.ui.reader.adapters.ReaderMenuAdapter
import org.sitebay.android.ui.reader.adapters.ReaderPostLikersAdapter
...
import org.sitebay.android.ui.reader.utils.ReaderVideoUtils
import org.sitebay.android.ui.reader.viewholders.PostLikerItemDecorator
...
import org.sitebay.android.ui.reader.views.ReaderIconCountView
...
import org.sitebay.android.ui.reader.views.ReaderWebView.ReaderCustomViewListener
import org.sitebay.android.ui.reader.views.ReaderWebView.ReaderWebViewPageFinishedListener
import org.sitebay.android.ui.reader.views.ReaderWebView.ReaderWebViewUrlClickListener
...
import org.sitebay.android.util.WPPermissionUtils.READER_FILE_DOWNLOAD_PERMISSION_REQUEST_CODE
import org.sitebay.android.util.WPSwipeToRefreshHelper.buildSwipeToRefreshHelper
...
import org.sitebay.android.widgets.WPScrollView
import org.sitebay.android.widgets.WPScrollView.ScrollDirectionListener
...
class ReaderPostDetailFragment : ViewPagerFragment(),
    ...
    override fun onUrlClick(url: String): Boolean {
        // if this is a "sitebay://blogpreview?" link, show blog preview for the blog - this is
