...
import org.sitebay.android.ui.posts.PostEditorAnalyticsSession.Outcome.CANCEL
import org.sitebay.android.ui.posts.PostEditorAnalyticsSession.Outcome.PUBLISH
import org.sitebay.android.ui.posts.PostEditorAnalyticsSession.Outcome.SAVE
...
import org.sitebay.android.ui.stories.StoryComposerActivity.Companion.STATE_KEY_ORIGINAL_STORY_SAVE_RESULT
