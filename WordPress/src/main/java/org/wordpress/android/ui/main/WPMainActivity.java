...
import org.sitebay.android.fluxc.store.AccountStore.AuthenticationErrorType;
...
import org.sitebay.android.fluxc.store.AccountStore.UpdateTokenPayload;
...
import org.sitebay.android.fluxc.store.SiteStore.OnAllSitesMobileEditorChanged;
import org.sitebay.android.fluxc.store.SiteStore.OnQuickStartCompleted;
import org.sitebay.android.fluxc.store.SiteStore.OnSiteChanged;
import org.sitebay.android.fluxc.store.SiteStore.OnSiteEditorsChanged;
...
import org.sitebay.android.ui.ShortcutsNavigator;
import org.sitebay.android.ui.WPTooltipView;
...
import org.sitebay.android.ui.bloggingreminders.BloggingRemindersManager;
...
import org.sitebay.android.ui.main.WPMainNavigationView.OnPageListener;
...
import org.sitebay.android.util.AuthenticationDialogUtils;
...
import static org.sitebay.android.fluxc.store.SiteStore.CompleteQuickStartVariant.NEXT_STEPS;
import static org.sitebay.android.login.LoginAnalyticsListener.CreatedAccountSource.EMAIL;
import static org.sitebay.android.push.NotificationsProcessingService.ARG_NOTIFICATION_TYPE;
import static org.sitebay.android.ui.JetpackConnectionSource.NOTIFICATIONS;
...
public class WPMainActivity extends LocaleAwareActivity implements
    ...
    private void trackDefaultApp() {
        Intent wpcomIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(getString(R.string.sitebaycom_sample_post)));
    ...
    public void onPostUploaded(OnPostUploaded event) {
        ...
        // it's visible. For more info see https://github.com/sitebay-mobile/WordPress-Android/issues/9604
