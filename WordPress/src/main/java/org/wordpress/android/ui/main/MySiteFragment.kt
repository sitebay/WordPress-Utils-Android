...
import com.sitebay.stories.compose.frame.FrameSaveNotifier.Companion.buildSnackbarErrorMessage
import com.sitebay.stories.compose.frame.StorySaveEvents.Companion.allErrorsInResult
...
import com.sitebay.stories.compose.story.StoryRepository.getStoryAtIndex
...
import org.sitebay.android.analytics.AnalyticsTracker.Stat.QUICK_START_MIGRATION_DIALOG_POSITIVE_TAPPED
import org.sitebay.android.analytics.AnalyticsTracker.Stat.QUICK_START_MIGRATION_DIALOG_VIEWED
import org.sitebay.android.analytics.AnalyticsTracker.Stat.QUICK_START_REMOVE_DIALOG_NEGATIVE_TAPPED
import org.sitebay.android.analytics.AnalyticsTracker.Stat.QUICK_START_REMOVE_DIALOG_POSITIVE_TAPPED
import org.sitebay.android.analytics.AnalyticsTracker.Stat.QUICK_START_REQUEST_DIALOG_NEGATIVE_TAPPED
import org.sitebay.android.analytics.AnalyticsTracker.Stat.QUICK_START_REQUEST_DIALOG_NEUTRAL_TAPPED
import org.sitebay.android.analytics.AnalyticsTracker.Stat.QUICK_START_REQUEST_DIALOG_POSITIVE_TAPPED
import org.sitebay.android.analytics.AnalyticsTracker.Stat.QUICK_START_TASK_DIALOG_NEGATIVE_TAPPED
import org.sitebay.android.analytics.AnalyticsTracker.Stat.QUICK_START_TASK_DIALOG_POSITIVE_TAPPED
import org.sitebay.android.analytics.AnalyticsTracker.Stat.QUICK_START_TASK_DIALOG_VIEWED
import org.sitebay.android.analytics.AnalyticsTracker.Stat.STORY_SAVE_ERROR_SNACKBAR_MANAGE_TAPPED
import org.sitebay.android.databinding.MySiteFragmentBinding
...
import org.sitebay.android.login.LoginMode.JETPACK_STATS
...
import org.sitebay.android.ui.FullScreenDialogFragment.Builder
import org.sitebay.android.ui.FullScreenDialogFragment.OnConfirmListener
import org.sitebay.android.ui.FullScreenDialogFragment.OnDismissListener
...
import org.sitebay.android.ui.photopicker.MediaPickerConstants.EXTRA_MEDIA_SOURCE
...
import org.sitebay.android.ui.posts.PromoDialog
import org.sitebay.android.ui.posts.PromoDialog.PromoDialogClickInterface
...
import org.sitebay.android.ui.quickstart.QuickStartMySitePrompts.Companion.getPromptDetailsForTask
import org.sitebay.android.ui.quickstart.QuickStartMySitePrompts.Companion.isTargetingBottomNavBar
import org.sitebay.android.ui.quickstart.QuickStartNoticeDetails
...
import org.sitebay.android.util.AccessibilityUtils.getSnackbarDuration
...
import org.sitebay.android.util.QuickStartUtils.Companion.addQuickStartFocusPointAboveTheView
import org.sitebay.android.util.QuickStartUtils.Companion.getNextUncompletedQuickStartTask
import org.sitebay.android.util.QuickStartUtils.Companion.isQuickStartInProgress
import org.sitebay.android.util.QuickStartUtils.Companion.removeQuickStartFocusPoint
...
import org.sitebay.android.util.requestEmailValidation
...
@Deprecated(
        "This class is being refactored, if you implement any change, please also update " +
                "{@link org.sitebay.android.ui.mysite.ImprovedMySiteFragment}"
)
