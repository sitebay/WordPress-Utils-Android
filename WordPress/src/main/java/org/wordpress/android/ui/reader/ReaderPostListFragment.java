...
import org.sitebay.android.fluxc.generated.ReaderActionBuilder;
...
import org.sitebay.android.fluxc.store.ReaderStore;
import org.sitebay.android.fluxc.store.ReaderStore.OnReaderSitesSearched;
...
import org.sitebay.android.ui.main.BottomNavController;
import org.sitebay.android.ui.main.SitePickerActivity;
import org.sitebay.android.ui.main.WPMainActivity;
import org.sitebay.android.ui.main.WPMainNavigationView;
import org.sitebay.android.ui.main.WPMainNavigationView.PageType;
...
import org.sitebay.android.ui.reader.ReaderEvents.TagAdded;
...
import org.sitebay.android.ui.reader.adapters.ReaderSearchSuggestionAdapter;
import org.sitebay.android.ui.reader.adapters.ReaderSearchSuggestionRecyclerAdapter;
import org.sitebay.android.ui.reader.adapters.ReaderSiteSearchAdapter;
import org.sitebay.android.ui.reader.adapters.ReaderSiteSearchAdapter.SiteSearchAdapterListener;
...
import org.sitebay.android.ui.reader.services.search.ReaderSearchServiceStarter;
...
import org.sitebay.android.ui.reader.subfilter.BottomSheetUiState.BottomSheetVisible;
...
import org.sitebay.android.ui.reader.viewmodels.ReaderModeInfo;
...
import static org.sitebay.android.ui.reader.ReaderActivityLauncher.OpenUrlType.INTERNAL;
...
public class ReaderPostListFragment extends ViewPagerFragment
    ...
    public void onResume() {
        super.onResume();
        /*
         * This is a workaround for https://github.com/sitebay-mobile/WordPress-Android/issues/11985.
