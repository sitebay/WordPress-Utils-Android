...
From there, add and enable the custom configuration file, located at [config/checkstyle.xml](https://github.com/sitebay-mobile/WordPress-Android/blob/develop/config/checkstyle.xml).
...
From there, add and enable the custom configuration file, located at [config/detekt/detekt.yml](https://github.com/sitebay-mobile/WordPress-Android/blob/develop/config/detekt/detekt.yml).
